/**
	Generates a random procedural for a level.
	Code by Chao, 2013
*/

Game.LevelGenerator = function(width, height) {
	this.Width = width;
	this.Height = height;
	this.Odds = [];
	this.TotalOdds = 0;
...
Game.LevelGenerator.prototype = {
	CreateLevel: function(type, difficulty) {
        ...
        this.Odds[Game.Odds.Cannon] = -10 + 5 * difficulty;
        ...
        if (type === Game.LevelType.Castle || type === Game.LevelType.Underground) {
